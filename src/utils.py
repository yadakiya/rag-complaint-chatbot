...
LOG_FILE_PATH = os.path.join(os.path.dirname(__file__), "../data/processed/pipeline.log")
...
def log_execution_time(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        logger.info(f"Finished pipeline step '{func.__name__}' inside {elapsed_time:.4f} seconds.")
        return result
    return wrapper